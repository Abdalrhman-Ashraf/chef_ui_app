...
Column list_eating_item(BuildContext context, dynamic dinners) {
    return Column(
      ...
      children: [
                  Text('اكلا تــي',style: getBodyTextStyle(context,fontSize: 33,fontWeight: FontWeight.bold,color: Appcolor.primary),),
Gap(10),
        Expanded(
                    ...
                    children: [      
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              dinner['name'],
                              style: getBodyTextStyle(context,fontSize:18,color: Appcolor.primary),
                            ),
                            Row(
                      ...
                      Column(
                        children: [
                          ...
                          Text(
                            dinner['price'],
                            style: getBodyTextStyle(context,fontSize: 25,color: Appcolor.black)
                          ),
                        ],
                      ),
                    ],
